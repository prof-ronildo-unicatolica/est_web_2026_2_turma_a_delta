...
import { calcularValorTotal, criarReserva } from '../../services/api'
...
export default function PaginaNovaReserva({ hotel, quarto, aoNavegar }) {
  ...
  async function handleSubmit(e) {
    ...
    setEnviando(true)
    try {
      // usuario_id e valor_total não são enviados: o backend deriva o
      // usuário a partir do token JWT e recalcula o valor a partir do
      // preço do quarto, para o cliente não poder manipular nem um nem
      // outro.
