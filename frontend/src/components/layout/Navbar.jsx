export default function Navbar({ pagina, aoNavegar, usuario, aoSair }) {
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          ...
          <div className="d-flex align-items-center gap-2">
            {usuario ? (
              <>
                <span className="text-light small d-none d-md-inline">Olá, {usuario.nome}</span>
                <button
              ...
              <button
                ...
                type="button"
                onClick={() => aoNavegar({ pagina: 'login' })}
              >
                Login
              </button>
            )}
