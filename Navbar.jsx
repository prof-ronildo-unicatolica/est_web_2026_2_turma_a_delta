      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav me-auto">
            ...
            {usuario?.is_admin && (
              <li className="nav-item">
                <a className={linkClasse('admin')} href="#" onClick={(e) => { e.preventDefault(); aoNavegar({ pagina: 'admin' }) }}>Admin</a>
              </li>
            )}
            <li className="nav-item">
              <a
          ...
          <div className="d-flex align-items-center gap-2">
            ...
            <button className="btn btn-outline-primary btn-sm px-3" type="button" onClick={() => aoNavegar({ pagina: "logout" })}>Sair</button>
          </div>
        </div>
      </div>
    </nav>
